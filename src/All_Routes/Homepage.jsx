...
const Homepage = () => {
  ...
  const data2 = [
    {
      url: "https://images.bewakoof.com/uploads/grid/app/revamped-banner-MID-SIZE-B1G1-02-1673359273.jpg",
    },
    {
    ...
    <div className="Main">
      <div style={{ marginTop: "15px" }} className="mobile">
        ...
        >
          <Item3>
            <Img
              className="mobileimg"
              src="https://images.bewakoof.com/nav_menu/mad-india-circle-icon-1673616489.png"
              alt="bewakoof"
            />
          </Item3>
          <Item3>
            <Img
              className="mobileimg"
              src="https://images.bewakoof.com/nav_menu/men-icon-1670851638.png"
              alt="bewakoof"
            />
          </Item3>
          <Item3>
            <Img
              className="mobileimg"
              src="https://images.bewakoof.com/nav_menu/women-icon-1670851639.png"
              alt="bewakoof"
            />
          </Item3>
          <Item3>
            <Img
              className="mobileimg"
              src="https://images.bewakoof.com/nav_menu/TopNav-168x168-icon-Accessories2-1669369840.png"
              alt="bewakoof"
            />
          </Item3>
          <Item3>
            <Img
              className="mobileimg"
              src="https://images.bewakoof.com/nav_menu/wmw-circle-icon-1673011178.png"
              alt="bewakoof"
            />
          </Item3>
          <Item3>
            <Img
              className="mobileimg"
              src="https://images.bewakoof.com/nav_menu/TopNav-168x168-icon-plus-1668515980.png"
              alt="bewakoof"
            />
          </Item3>
          <Item3>
            <Img
              className="mobileimg"
              src="https://images.bewakoof.com/uploads/grid/app/01-TopNavigationIcon-140x140-custom-min-1658484767.png"
              alt="bewakoof"
            />
          </Item3>
          <Item3>
            <Img
              className="mobileimg"
              src="https://images.bewakoof.com/nav_menu/TopNav-168x168-icon-Playp-1669267652.png"
              alt="bewakoof"
            />
          </Item3>
          <Item3>
            <Img
              className="mobileimg"
              src="https://images.bewakoof.com/nav_menu/TopNav-168x168-icon-undrdawg1-1669267652.png"
              alt="bewakoof"
            />
          </Item3>
        </Carousel>
      ...
      <div style={{ marginTop: "0px" }}>
        ...
        >
          <Item1>
            <Img
              src="https://images.bewakoof.com/uploads/grid/app/new-thumbnail-icon-2022-bestseller-1671624963.jpg"
              alt="bewakoof"
            />
          </Item1>
          <Item1>
            <Img
              src="https://images.bewakoof.com/uploads/grid/app/Thumbnail-New-Arrivals-Common-1668508339.jpg"
              alt="bewakoof"
            />
          </Item1>
          <Item1>
            <Img
              src="https://images.bewakoof.com/uploads/grid/app/hotdeals-2-1668491210.jpg"
              alt="bewakoof"
            />
          </Item1>
          <Item1>
            <Img
              src="https://images.bewakoof.com/uploads/grid/app/Thumbnail-Collabs-Common-1668508338.jpg"
              alt="bewakoof"
            />
          </Item1>
          <Item1>
            <Img
              src="https://images.bewakoof.com/uploads/grid/app/last-size-new-thumbnaik-1668508337.jpg"
              alt="bewakoof"
            />
          </Item1>
          <Item1>
            <Img
              src="https://images.bewakoof.com/uploads/grid/app/new-thumbnail-icon-2022-copy-1669723278.jpg"
              alt="bewakoof"
            />
          </Item1>
          <Item1>
            <Img
              src="https://images.bewakoof.com/uploads/grid/app/me-shirt-thumbnail-1668508337.jpg"
              alt="bewakoof"
            />
          </Item1>
          <Item1>
            <Img
              src="https://images.bewakoof.com/uploads/grid/app/image-1668598708.png"
              alt="bewakoof"
            />
          </Item1>
        </Carousel>
      ...
      <table style={{ width: "95%", margin: "auto" }}>
        <tr>
          <td>
            <Img
              src="https://images.bewakoof.com/uploads/grid/app/DOTW-Split-banner-Desktop-men-1674030025.jpg"
              alt="bewakoof"
            />
          </td>
          <td>
            <Img
              src="https://images.bewakoof.com/uploads/grid/app/DOTW-Split-banner-Desktop-Women-1674030025.jpg"
              alt="bindass"
            />
          </td>
        </tr>
      ...
      <div style={{ marginTop: "10px" }}>
        ...
        >
          <Item>
            <Img
              className="carouselsm"
              src="https://images.bewakoof.com/uploads/grid/app/hot-new-evrythng-1x1-01-1672806265.gif"
              alt="bewakoof"
              height={"450px"}
            />
          </Item>
          <Item>
            <Img
              className="carouselsm"
              src="https://images.bewakoof.com/uploads/grid/app/static-1x1-indo-common-1673685812.jpg"
              alt="bewakoof"
              height={"450px"}
            />
          </Item>
          <Item>
            <Img
              className="carouselsm"
              src="https://images.bewakoof.com/uploads/grid/app/puffer-40-off-1673631220.jpg"
              alt="bewakoof"
              height={"450px"}
            />
          </Item>
          <Item>
            <Img
              className="carouselsm"
              src="https://images.bewakoof.com/uploads/grid/app/ovrszd-tees-1x1-common1-1674129220.jpg"
              height={"450px"}
              alt="bewakoof"
            />
          </Item>
      ...
      <Img
        src="https://images.bewakoof.com/uploads/grid/app/desktop-survey-1673330211.jpg"
        alt="banner"
        className="images"
      />
      <div className="items3">
